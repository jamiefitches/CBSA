#ifndef DSelector_Spring18_h
#define DSelector_Spring18_h
...
class DSelector_Spring18 : public DSelector
{
	public:

		DSelector_Spring18(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_Spring18(){}
	...
	ClassDef(DSelector_Spring18, 0);
};

void DSelector_Spring18::Get_ComboWrappers(void)
{
	//Step 0
...
Bool_t DSelector_Spring18::Fill1DHisto(TH1I* hist, Double_t x, int IsPrompt){
	if(IsPrompt==1){
		hist->Fill(x);
		return kTRUE;
	}
