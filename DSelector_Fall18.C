#include "DSelector_Fall18.h"
#include <TEnv.h>
#include <sstream>

void DSelector_Fall18::Init(TTree *locTree)
{
	...
	dOutputFileName = "Fall18.root"; //"" for none
	...
	const char *efile = "Efiles/Fall18Efile";
...
Bool_t DSelector_Fall18::Process(Long64_t locEntry)
{
...
void DSelector_Fall18::Finalize(void)
{
