#include "DSelector_Spring18.h"
#include <TEnv.h>
#include <sstream>

void DSelector_Spring18::Init(TTree *locTree)
{
	...
	dOutputFileName = "Spring18.root"; //"" for none
	...
	const char *efile = "Efile/Spring18Efile"; 
...
Bool_t DSelector_Spring18::Process(Long64_t locEntry)
{
...
void DSelector_Spring18::Finalize(void)
{
