#ifndef DSelector_Spring17_h
#define DSelector_Spring17_h
...
class DSelector_Spring17 : public DSelector
{
	public:

		DSelector_Spring17(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_Spring17(){}
	...
	ClassDef(DSelector_Spring17, 0);
};

void DSelector_Spring17::Get_ComboWrappers(void)
{
	//Step 0
...
Bool_t DSelector_Spring17::Fill1DHisto(TH1I* hist, Double_t x, int IsPrompt){
	if(IsPrompt==1){
		hist->Fill(x);
		return kTRUE;
	}
